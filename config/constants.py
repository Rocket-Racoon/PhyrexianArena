...
class SetTypes(models.TextChoices):
    ...
    MASTERS     = "masters", "Masters Set"
    MASTERPIECE = "masterpiece", "Masterpiece Series"
    COMMANDER   = "commander", "Commander Decks"
    STARTER     = "starter", "Starter Set"
    BOX         = "box", "Box Set"
    ARSENAL     = "arsenal", "Commander Arsenal"
    VAULT       = "from_the_vault", "From the Vault Series"
    SPELLBOOK   = "spellbook", "Spellbook Series"
    PREMIUM     = "premium_deck", "Premium Deck Series"
    DUEL        = "duel_deck", "Duel Decks Series"
    DRAFT       = "draft_innovation", "Draft Innovation"
    PLANCHASE   = "planechase", "Planchase Set"
    ARCHENEMY   = "archenemy", "Archenemy Set"
    VANGUARD    = "vanguard", "Vanguard Set"
    UNSET       = "un_set", "Un-Set"
    FUNNY       = "funny", "Funny Set"
    JUMPSTART   = "jumpstart", "Jumpstart"
    PROMO       = "promo", "Promotional"
    TOKEN       = "token", "Token"
    ALCHEMY     = "alchemy", "Alchemy Set"
    TREASURE    = "treasure_chest", "MO Treasure Chest Prize Set"
